...
function buildRequirementsLabel(settings) {
  if (settings.format === SCRIM_FORMATS.meta) {
    return "Modo Meta: 1 Healer, 1 Rdps, 1 Dps, 1 Tank y 1 Putre por equipo.";
  }
...
function buildFakeDescription(fakePreset) {
  ...
  return "Preset Default: entran 2 Healers fijos y una mezcla base de Tank, Rdps, Putre y Dps.";
}
